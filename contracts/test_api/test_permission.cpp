...
void test_permission::check_authorization(uint64_t receiver, account_name code, uint64_t action) {
   (void)code;
   (void)action;
...
void test_permission::test_permission_last_used(uint64_t /* receiver */, account_name code, uint64_t action) {
   (void)code;
   (void)action;
   using namespace eosio;
...
void test_permission::test_account_creation_time(uint64_t /* receiver */, account_name code, uint64_t action) {
   (void)code;
   (void)action;
   using namespace eosio;
