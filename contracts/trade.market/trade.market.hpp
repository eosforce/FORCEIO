...
namespace eosio {
   ...
   class market : public contract {
      public:
         ...
         void addmarket(account_name market_maker,trade_type type,asset coinbase_amount,account_name coinbase_account,uint64_t base_weight,
               asset coinmarket_amount,account_name coinmarket_account,uint64_t market_weight);//新增一个交易对    
